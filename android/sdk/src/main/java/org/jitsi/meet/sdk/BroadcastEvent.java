...
public class BroadcastEvent {
    ...
    public enum Type {
        ...
        COLLAPSE_VIDEO("org.jitsi.meet.COLLAPSE_VIDEO"),
        ...
        private static final String COLLAPSE_VIDEO_NAME = "COLLAPSE_VIDEO";
        ...
        private static Type buildTypeFromName(String name) {
            switch (name) {
                case COLLAPSE_VIDEO_NAME:
                    return COLLAPSE_VIDEO;
